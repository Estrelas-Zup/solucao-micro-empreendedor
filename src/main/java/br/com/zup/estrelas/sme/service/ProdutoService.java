...
public class ProdutoService implements IProdutoService {
    ...
    public MensagemDTO alterarProduto(Long idProduto, ProdutoDTO produtoDTO) {
        ...
        if (produtoProcurado.isPresent()) {
            ...
            produtoAlterado.setNome(produtoDTO.getNome());
            produtoAlterado.setDescricao(produtoDTO.getDescricao());
            produtoAlterado.setUnidadeMedida(produtoDTO.getUnidadeMedida());
            produtoAlterado.setValorCusto(produtoDTO.getValorCusto());
            produtoAlterado.setValorVenda(produtoDTO.getValorVenda());
            produtoAlterado.setMargemDesconto(produtoDTO.getMargemDesconto());
